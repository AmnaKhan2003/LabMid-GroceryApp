...
export default function Logout() {
  ...
  return (
    ...
    <div className='flex items-center justify-between'>
        ...
        <div>
            <button className='text-black text-2xl mr-5 cursor-pointer font-bold hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 transition-normal duration-300 ease-in-out' onClick={() => navigate('/')}>Logout</button>
        </div>
    </div>
    </div>
    </>
